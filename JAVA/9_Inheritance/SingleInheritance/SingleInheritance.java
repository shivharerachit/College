...
class Sports extends Personal{
    ...
    void getSportInfo(){
        ...
        if(S_part==2){
            ...
            System.out.println("Entered wrong value please re-enter.");
            getSportInfo();
        }
        flag2=true;
    }
...
class SingleInheritance {
    public static void main(String[] args){
        ...
        // Personal student1 = new Personal();
        // student1.getInfo();
        // student1.showInfo();

        // Academic student1 = new Academic();
        // student1.getAcademicInfo();
        // student1.showMarksheet();

        Sports student1 = new Sports();
        student1.getSportInfo();
